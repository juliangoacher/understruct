...
Object.defineProperty( Server.prototype, 'mode', {
    get: function() {
        return this._mode;
    },
    set: function( mode ) {
        if( mode != 'local' && mode != 'remote' ) {
            throw new Error(`ipc/Server: Bad mode '${mode}'`);
        }
        this._mode = mode;
    }
});
 ...
 */
function Server( serverID, appspace, logger ) {
    this._ipc = IPC.make( serverID, appspace, logger );
...
Server.prototype.events = function() {
    this._events = Array.from( arguments );
}
