...
/*
let xtest = compile(['html','cli']);
console.log('array def');
[{ html: true },{ html: {} },{ html: {}, cli: {} }].forEach( obj => console.log(xtest(obj)) );

xtest = compile({ html: 'object', cli: 'array' });
console.log('object def');
[{ html: true },{ html: {} },{ html: {}, cli: [] }].forEach( obj => console.log(xtest(obj)) );

xtest = compile({ html: 'object', cli: { name: 'string', args: 'array' } });
console.log('nested def');
[{ html: true },{ html: {} },{ html: {}, cli: { name: 'xxx', args: [] } }].forEach( obj => console.log(xtest(obj)) );

xtest = compile({ html: 'object', cli: 'xxx' });
*/
